...
bc(language-markup). <txp:oui_instagram_user />
...
bc(language-markup).. <txp:oui_instagram_user>
    <txp:oui_instagram_user_info />
    <txp:oui_instagram_user_count />
</txp:oui_instagram_user>
...
bc(language-markup).. <txp:oui_instagram_images limit="5">
    <txp:oui_instagram_image />
    <txp:oui_instagram_image_url />
    <txp:oui_instagram_image_info />
    <txp:oui_instagram_image_author />
    <txp:oui_instagram_image_date />
