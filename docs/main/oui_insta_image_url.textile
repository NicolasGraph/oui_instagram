notextile. <section id="oui_insta_image_url" class="options_group">

h2. oui_insta_image_url

p(alert-block warning). %(ui-icon ui-icon-alert).% @oui_instagram_image_url@ tag is now deprecated.
