...
* *v1.0.0* (2016-12-12) :
** adds @<txp:oui_instagram_author />@ and @<txp:oui_instagram_author_info />@ tags;
** removes cache (an external cache system such "aks_cache":http://forum.textpattern.com/viewtopic.php?id=33460 should be used);
** restores the @access_token@ attribute and removes @username@ and @user_id@ whivh needs restricted Instagram registration;
** introduces an attribute values inheritance in a container tag context;
** changes @<txp:oui_instagram_image_author />@ @title@ attribute to @type@;
