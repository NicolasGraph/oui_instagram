...
h3(#oui_instagram_images). <txp:oui_instagram_images />
...
h3(#oui_instagram_image). <txp:oui_instagram_image />
...
bc(#oui_instagram_image_info). <txp:oui_instagram_image_info />
...
h3(#oui_instagram_image_url). <txp:oui_instagram_image_url />
...
h3(#oui_instagram_image_date). <txp:oui_instagram_image_date />
...
h3(#oui_instagram_image_author). <txp:oui_instagram_image_author />
